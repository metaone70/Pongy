...
BALL_DIRECTION_AT_START
        ...
        LDA $D41B               ; LOAD THE PSUEDO RANDOM NUMBER (UPTO 200)
        CMP #$32                
        BCC BUL
        CMP #$64
        BCC BDL
...
;BALL DIRECTION AT START TEMPORARILY--------------------------------------------
BALL_DIRECTION_TEMP
        LDA #$01
        STA BALLDIRECTION
        RTS
...
; BALL MOVING UP & LEFT---------------------------------------------------
BALL_UP_LEFT
        DEC BALLX                 ; DECREMENT THE X POS (TO LEFT)
        DEC BALLY                 ; DECREMENT THE Y POS (TO UP)
        JSR EXPANDBALLMSB
        RTS
...
BALL_DOWN_LEFT
        DEC BALLX                 ; DECREMENT THE X POS (TO LEFT)
        INC BALLY                 ; INCREMENT THE Y POS (TO DOWN)
        JSR EXPANDBALLMSB
        RTS

; BALL MOVING UP & RIGHT--------------------------------------------------
BALL_UP_RIGHT
        INC BALLX                 ; DECREMENT THE X POS (TO LEFT)
        DEC BALLY                 ; INCREMENT THE Y POS (TO DOWN)
        JSR EXPANDBALLMSB
        RTS
...
*=$4C00 
        ...
        BYTE    $05,$01,$01,$01,$01,$01,$01,$01,$01,$01,$01,$01,$01,$01,$01,$00,$00,$00,$00,$05,$05,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$05,$00,$00,$05
