...
P1J     STX SPRITEPOS+1         ; STORE IT ON THE POSITION -> JOYSTICK ROUTINE JOINS FROM HERE
        LDX SPRITEPOS+1
        CPX #$40                ; CHECK IF IT IS ALREADY ON THE TOP 
        BCS SETUP1              ; IF NOT, GO AND CHECK IF IT IS AT THE BOTTOM
        LDX #$40                ; YES, IT IS AT THE TOP SO LOCK IT

SETUP1  CPX #$C4                ; IS IT AT THE BOTTOM?
        BCC SETUP2              ; NO, GO AND STORE IT TO THE TABLE
        LDX #$C4                ; YES, IT IS AT THE BOTTOM SO LOCK IT
...
P2J     STY SPRITEPOS+3         ; STORE IT ON THE POSITION -> JOYSTICK ROUTINE JOINS FROM HERE
        LDY SPRITEPOS+3
        CPY #$40                ; CHECK IF IT IS ALREADY ON THE TOP 
        BCS SETUP3              ; IF NOT, GO AND CHECK IF IT IS AT THE BOTTOM
        LDY #$40                ; YES, IT IS AT THE TOP SO LOCK IT
        
SETUP3  CPY #$C4                ; IS IT AT THE BOTTOM?
        BCC SETUP4              ; NO, GO AND STORE IT TO THE TABLE
        LDY #$C4                ; YES, IT IS AT THE BOTTOM SO LOCK IT
...
;SPRITE 0 DATA ; PLAYER 1 - RIGHT PLAYER --> POINTER $80
 ...
 byte $00,$3F,$00,$00,$3F,$00,$00,$3F,$00,$00,$3F,$00,$00,$2A,$00,$00
 byte $2A,$00,$00,$2A,$00,$00,$2A,$00,$00,$2A,$00,$00,$2A,$00,$00,$3F
 byte $00,$00,$3F,$00,$00,$3F,$00,$00,$3F,$00,$00,$00,$00,$00,$00,$00

;SPRITE 1 DATA ; PLAYER 2 - LEFT PLAYER --> POINTER $81
 byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$FC
 byte $00,$00,$FC,$00,$00,$FC,$00,$00,$FC,$00,$00,$A8,$00,$00,$A8,$00
 byte $00,$A8,$00,$00,$A8,$00,$00,$A8,$00,$00,$A8,$00,$00,$FC,$00,$00
 byte $FC,$00,$00,$FC,$00,$00,$FC,$00,$00,$00,$00,$00,$00,$00,$00,$00
